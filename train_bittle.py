...
model = SAC('MlpPolicy', env, learning_starts = 0, use_sde=False, use_sde_at_warmup=False, verbose=1, tensorboard_log="./sac_opencat_tensorboard/").learn(4.5e5)

#model.save("sac_opencat_bittle_simple_4_3")
